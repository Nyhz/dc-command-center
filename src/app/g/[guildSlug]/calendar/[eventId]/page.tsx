...
export default async function GuildEventDetailPage({
  params,
}: {
  params: Promise<{ guildSlug: string; eventId: string }>;
}) {
  const { guildSlug, eventId } = await params;
  ...
  // Get user's characters in this guild for the attendance toggle
